...
<body>
<div id="crm_layout" class="easyui-layout" style="width:600px;height:400px;">   
    <div data-options="region:'north'"  style="height:100px;background: url('/img/banner-pic.gif') no-repeat;background-size:cover">
    	<h1>客户关系管理</h1>
    </div>   
    <div data-options="region:'south',split:true" style="height:30px;background: url('/img/banner-pic.gif')">
    	<center>版权所有</center>
    </div>   
