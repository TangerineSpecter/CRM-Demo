...
<link rel="stylesheet" type="text/css" href="/js/jquery-easyui/themes/metro/easyui.css"><!-- 样式文件 -->   
...
<div class="login">
	...
	<form method="post">
		...
		<input type="button" class="btn btn-primary btn-block btn-large" onclick="submitForm()" value="登录" />
	</form>
</div>
